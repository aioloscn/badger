package com.aiolos.badgeridgenerator.provider.rpc;

import cn.hutool.core.thread.ThreadUtil;
import cn.hutool.json.JSONUtil;
import com.aiolos.badgerenums.exceptions.ServiceExceptionEnum;
import com.aiolos.badgeridgenerator.api.IdGeneratorApi;
import com.aiolos.badgeridgenerator.provider.bo.LocalNonSeqIdBO;
import com.aiolos.badgeridgenerator.provider.bo.LocalSeqIdBO;
import com.aiolos.badgermodel.po.IdGenerateConfigPO;
import com.aiolos.badgerservice.service.IdGenerateConfigService;
...
public class IdGeneratorApiImpl implements IdGeneratorApi {
    ...
    private final Map<Integer, LocalSeqIdBO> localSeqIdMap = new ConcurrentHashMap<>();
    private final Map<Integer, LocalNonSeqIdBO> localNonSeqIdMap = new ConcurrentHashMap<>();
